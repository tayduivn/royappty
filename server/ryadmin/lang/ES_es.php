<?php
  ...
  ************************************************************/
  ...
  $s["date"] = "Fecha";
  $s["accept"] = "Aceptar";
  $s["used_codes"] = "Códigos usados";
  $s["last_connection"] = "Última conexión";
  $s["created"] = "Creación";
  $s["creation_date"] = "Creación";
  $s["groups"] = "Grupos";
  $s["user(s)"] = "Usuario(s)";
  $s["save"] = "Guardar";
  ...
  $signup_s["select_subscription_type"] = "Selecciona el tipo de subscripción";
  $signup_s["app_data"] = "Datos de la Aplicación";
  ...
  $signup_s["success_subtitle"] = "Bienvenido a Royappty, tu cuenta ha sido creada. Tu cuenta está inactiva, pide a otro administrador que la active.";
  ...
  $s["brands"] = "Marcas";
  $s["all_brands"] = "Todas las Marcas";
  $s["new_brand"]= "Crear nueva Marca";
  ...
  $generate_ios_app_steps[4]["content"] = "<p>".htmlentities("Seleccionar dentro del submenu Provision Profile Desarrollo y pulsar el botón más. Seleccionar iOS App Development y pulsar siguiente. En el Selectro de App ID seleccionar el App ID de la aplicación. Selecciona el certificado de desarrollador y el de dispositivo. Nombra el perfil con ID del proyecto. Descarga el perfil.", ENT_QUOTES, "UTF-8")."</p><p>".htmlentities("Instala el perfil en el ordenador haciendo doble click.", ENT_QUOTES, "UTF-8")."</p>";
  $generate_ios_app_steps[5]["title"] = "Paso 5 | Generar Proyecto iOS";
  $generate_ios_app_steps[5]["content"] = "<p>".htmlentities("Pulsa el botón generar aplicación iOS y una vez finalizado el proceso descárgate la aplicación comprimida y descárgala en el ordenador.", ENT_QUOTES, "UTF-8")."</p>";
  $s["download_ios_app"] = "Descargar Proyecto iOs";
  $generate_ios_app_steps[6]["title"] = "Paso 6 | Abrir Proyecto y seleccionar perfil";
  $generate_ios_app_steps[6]["content"] = "<p>".htmlentities("Descomprimir la carpeta y ejecutar el script ios-builder. Una vez finalizado el script se abrirá el proyecto en Xcode. Dentro de Xcode seleccionar el proyecto en la barra derecha. En la barra superior seleccionamos el proyecto (hoja color azul) y dentro de las opciones accedemos a Build Settings. Dentro de las opciones de compilado de la aplicación seleccionamos en las opciones de formado Code Signing en Provision profile seleccionamos el perfil del proyecto.", ENT_QUOTES, "UTF-8")."</p>";
  $generate_ios_app_steps[7]["title"] = "Paso 7 | Exportar Certificado";
  $generate_ios_app_steps[7]["content"] = "<p>".htmlentities("Abrir Keychain Access y arrastras el certificado descargado al llavero. Aparecerá con el nombre Apple Development iOS Push Notification Services y el nombre del componente de la aplicación. Seleccionarlo y con botón derecho seleccionar exportar con el nombre apns, escoger como contraseña royappty. Expandir el certificado y exportar la llave con el nombre apns-key, escoger como contraseña royappty. Abrir un terminal y acceder al directorio donde están los dos certificados exportados. Ejecutar", ENT_QUOTES, "UTF-8")."</p>";
  $generate_ios_app_steps[7]["commands"] = "openssl pkcs12 -clcerts -nokeys -out apns-cert.pem -in apns.p12<br/>openssl pkcs12 -nocerts -out apns-key.pem -in apns-key.p12<br/>openssl rsa -in apns-key.pem -out apns-key-noenc.pem<br/>cat apns-cert.pem apns-key-noenc.pem >> apns-dev.pem";
  $generate_ios_app_steps[8]["title"] = "Paso 8 | Subir Certificado";
  $generate_ios_app_steps[8]["content"] = "<p>".htmlentities("Arrastra el certificado generado apns-dev.pem", ENT_QUOTES, "UTF-8")."</p>";
  ...
  $resume_block_s["total_campaigns"] = "Campañas";
  $resume_block_s["total_brands"] = "Marcas";
  $resume_block_s["total_users"] = "Usuarios";
  $resume_block_s["total_monthly_revenue"] = "Beneficio Mensual";
  ...
  $error_step_s["post_no_update_data_cif"]= "No se ha enviado correctamente el campo CIF";
  $error_step_s["post_no_update_data_contact_email"]= "No se ha enviado correctamente el campo Email de contacto";
  $error_step_s["post_no_update_data_contact_address"]= "No se ha enviado correctamente el campo Dirección";
  $error_step_s["post_no_update_data_contact_postal_code"]= "No se ha enviado correctamente el campo Código postal";
  $error_step_s["post_no_update_data_contact_city"]= "No se ha enviado correctamente el campo Ciudad";
  $error_step_s["post_no_update_data_contact_country"]= "No se ha enviado correctamente el campo País";
