...
************************************************************/
	...
	*********************************************************/
	...
	$page_path="server/ryadmin/ajax/brands/ios/generate_step_9";
	...
	*********************************************************/
	...
	$message=shell_exec("./generator_step_9.sh ".$app["project_codename"]." ".$app["package_address"]." ".$app["project_codename"]);
