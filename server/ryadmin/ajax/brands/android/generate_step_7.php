<?php
	...
	*********************************************************/
	...
	$page_path="server/ryadmin/ajax/brands/android/generate_step_7";
	...
	*********************************************************/
	...
	$message=shell_exec("./generator_step_7.sh ".$brand["android_project_name"]." com.royappty.".$brand["android_project_name"]." ".$brand["android_project_name"]." ".$brand["id_brand"]);
