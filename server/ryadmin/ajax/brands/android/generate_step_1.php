<?php
	...
	*********************************************************/
	...
	$page_path="server/ryadmin/ajax/brands/android/generate_step_1";
	...
	*********************************************************/
	...
	$message=shell_exec("./generator_step_1.sh ".$brand["android_project_name"]." com.royappty.".$brand["android_project_name"]." ".$brand["android_project_name"]."");
