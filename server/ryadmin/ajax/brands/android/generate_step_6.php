<?php
	...
	*********************************************************/
	...
	$page_path="server/ryadmin/ajax/brands/android/generate_step_6";
	...
	*********************************************************/
	...
	$message=shell_exec("./generator_step_6.sh ".$brand["android_project_id"]." com.royappty.".$brand["android_project_name"]." ".$brand["name"]."");
