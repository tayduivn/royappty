...
$s["lock_account_selection_warning"] = "Block allow your data (campaigns, administrators, users, configuration and reports) remain stored for 6 months. Having past this time period, it will be deleted from the system. This option will allow you reactivate your account without any data loss before this 6 month deadline.";
$s["delete_account_selection_warning"] = "Delete now will delete all data associated to your account (campaigns, administrators, users, reports and all app configuration). It is really important you understand this option cannot be undone having started.";
