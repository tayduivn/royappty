...
$signup_s["admin_data"] = "Crea el primer administrador para tu Royappty";
$signup_s["admin_name"] = "Nombre del Administrador";
$signup_s["admin_name_help"] = "Las acciones de los administradores quedarán guardadas, es importante que puedas identificarlos con su nombre.";
$signup_s["admin_email"] = "Correo electrónico del Administrador";
$signup_s["admin_email_help"] = "Este será el correo que se usará para acceder al manager de la aplicación.";
$signup_s["admin_promo_password"] = "Contraseña de Validación de Promociones";
$signup_s["admin_promo_password_help"] = "Este es el código que usarás para validar las promociones.";
$signup_s["admin_password"] = "Contraseña del Administrador";
$signup_s["admin_password_help"] = "Te aconsejamos que uses una contraseña segura con un mínimo de 8 caracteres.";
$signup_s["admin_password_repeat"] = "Repetir contraseña";
$signup_s["admin_password_repeat_help"] = "Repetir contraseña";
$signup_s["select_subscription_type"] = "Selecciona el tipo de subscripción";
$signup_s["app_data"] = "Datos de la Aplicación";
$signup_s["app_data_help"] = "Perdite todos estos datos puede parecerte precipitado, pero si no los tienes no pasa nada. Danos al menos un nombre y nuestro equipo ya se encargará de ayudarte para conseguir que tu aplicación tenga un aspecto fantástico.";
...
$signup_s["app_description_help"] = "Escribe unas lineas sobre lo que promociones piensas ofrecer (tampoco necesitas ser Cervantes, ni escribirlo ahora mismo, nuestro equipo se encargará de ayudarte a tener la mejor de las descripciones)";
...
$signup_s["subscription_data"] = "Selecciona plan de precios";
...
$s["lock_account_subtitle"] = "Queremos darte las gracias por haber confiado en nosotros y esperamos volver a verte pronto.";
