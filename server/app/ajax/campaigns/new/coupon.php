				...
				<div class='row'>
					<div class='col-md-8'>
						<div class='form-group'>
							...
							<div class='controls'>
								<input type='text' class='form-control ' id='title' placeholder='".htmlentities($new_coupon_s["promo_title_placeholder"], ENT_QUOTES, "UTF-8")."' onkeypress=\"$('#title-preview').html($('#title').val());\"/>
							</div>
						</div>
						<div class='row'>
							<div class='col-md-12'>
						...
						<div class='form-group'>
							...
							<div class='controls'>
								<textarea class='form-control' rows='6' id='content' onkeypress=\"$('#content-preview').html($('#content').val());\" onchange=\"$('#content-preview').html($('#content').val());\"></textarea>
							</div>
						</div>
						<div class='form-group'>
							...
							<div class='controls'>
								<input type='text' class='form-control ' id='button_title' placeholder='".htmlentities($new_coupon_s["button_title_placeholder"], ENT_QUOTES, "UTF-8")."'  onkeypress=\"$('#button-preview').html($('#button_title').val());\"/>
							</div>
						</div>
					</div>
					<div class='col-md-4'>
			...
			<div class='row'>
				<div class='col-md-12'>
					<div class='form-group'>
						...
						<div class='controls'>
							<input type='text' class='form-control ' id='coupons_number' placeholder='".htmlentities($new_coupon_s["coupons_number_placeholder"], ENT_QUOTES, "UTF-8")."'/>
						</div>
					</div>
				</div>
			</div>
			<div class='row'>
				<div class='col-md-12'>
					<div class='form-group'>
						...
						<div class='controls'>
							<input type='text' class='form-control ' id='usage_limit' placeholder='".htmlentities($new_coupon_s["promo_usage_limit_placeholder"], ENT_QUOTES, "UTF-8")."'/>
						</div>
					</div>
				</div>
			</div>
