 			...
 			<div class='navbar-inner'>
 				<div class='header-seperation'>
 					<ul class='nav pull-left notifcation-center' id='main-menu-toggle-wrapper' style='display:none'>
 						<li class='dropdown'> <a id='main-menu-toggle' href='".$url_server."/app/'  class='' > <div class='iconset top-menu-toggle-white'></div> </a> </li>		 
 					</ul>
 					<a href='../'><img src='".$url_server."server/app/assets/img/royappty-logo-white.png' class='logo' alt=''  data-src='".$url_server."server/app/assets/img/royappty-logo-white.png' data-src-retina='".$url_server."server/app/assets/img/royappty-logo-white.png' height='30'/></a>
 				</div>
 				<div class='header-quick-nav' > 
 					...
 					<div class='pull-right'>
 						<ul class='nav quick-section '>
 							<li class='quicklinks'>
 								<a href='javascript:location.reload()'><i class='fa fa-refresh'></i></a>
 							</li>
 							<li class='quicklinks'>
 								<a data-toggle='dropdown' class='dropdown-toggle  pull-right ' href='../#' id='user-options'><i class='fa fa-cog '></i></a>
 								<ul class='dropdown-menu  pull-right' role='menu' aria-labelledby='user-options'>
 									<li><a href='../user-profile/'> ".htmlentities($s["my_account"], ENT_QUOTES, "UTF-8")."</a></li>
 									<li class='divider'></li>                
