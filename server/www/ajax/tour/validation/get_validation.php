    ...
    <div class='container'>
      <div class='row p-t-20'>
        ...
        <div class='col-md-10 text-center'>
          ...
          <h4>".htmlentities($s["validation_1_content_1"], ENT_QUOTES, "UTF-8")."</h4>
          <h4>".htmlentities($s["validation_1_content_2"], ENT_QUOTES, "UTF-8")."</h4>
        </div>
        <div class='col-md-1'>
        </div>
      </div>
      ...
      <div class='row p-t-20'>
        ...
        <div class='col-md-10 text-center'>
          ...
          <h4>".htmlentities($s["validation_2_content_1"], ENT_QUOTES, "UTF-8")."</h4>
          <h4>".htmlentities($s["validation_2_content_2"], ENT_QUOTES, "UTF-8")."</h4>
        </div>
        <div class='col-md-1'>
        </div>
      </div>
