  ...
  <div class='container'>
    <div class='compressed'>
      <div class='navbar-header'>
        ...
        <a href='".PATH."./index.html' class='navbar-brand compressed'><img src='".PATH."assets/img/royappty-logo.png' data-src='".PATH."assets/img/royappty-logo.png' data-src-retina='assets/img/royappty-logo.png' height='44' alt=''/></a>
      </div>
      ...
      <div class='pricing-holder'>
          <div class='inner'>
            <div class='title text-center'>
              <img src='".PATH."assets/img/royappty-logo.png' data-src='".PATH."assets/img/royappty-logo.png' data-src-retina='".PATH."assets/img/royappty-logo.png' height='44' alt=''/>
            ...
            <a href='".PATH."./app/signup/' class='btn btn-block btn-success'>".htmlentities($s["pricing_starter_btn_hire"], ENT_QUOTES, "UTF-8")."</a>
      ...
      <div class='col-md-4 m-b-30'>
        <div class='pricing-holder'>
          <div class='inner'>
            ...
            <a href='".PATH."./app/signup/' class='btn btn-block btn-success' >".htmlentities($s["pricing_unlimited_btn_hire"], ENT_QUOTES, "UTF-8")."</a>
